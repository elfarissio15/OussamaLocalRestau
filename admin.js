...
function updateFaqData(FaqData) {
    fetch('http://localhost:3000/updateFaq', {
        method: 'POST',
        headers: {
...
function updatePromotionData(promotion) {
    fetch('http://localhost:3000/updatePromotions', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function updateReclamationData(ReclamationData) {
    fetch('http://localhost:3000/updateReclamation', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function updateCommentesData(CommentData) {
    fetch('http://localhost:3000/updateCommentes', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function removefaqQustion(FaqData){
    fetch('http://localhost:3000/removeFaq', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function removePromotionData(PromotionData){
    fetch('http://localhost:3000/removePromotions', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function removeReclamationData(ReclamationData){
    fetch('http://localhost:3000/removeReclamation', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function removeCommandeData(CommandeData){
    fetch('http://localhost:3000/removeCommande', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function addfaqQustion(FaqData){
    fetch('http://localhost:3000/insertfaqs', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function addmessageData(message){
    fetch('http://localhost:3000/insertmessages', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function updateCommandeData(CommandeData) {
    fetch('http://localhost:3000/updateCommandes', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
